...
class myPlayer(AdvancePlayer):
    ...
    def SelectMove(self, moves, game_state):
        ...
        def Moves_cutted(moves, cut_num, my_id, my_gs):
        ...
        def minimax(gamecopy, depth, maximizingPlayer,start_t):
            ...
            if maximizingPlayer:
                ...
                moves_me = Moves_cutted(moves_me, cut_num, self.id, gamecopy)
                ...
                moves_op = Moves_cutted(moves_op, cut_num, self.opid, gamecopy)
        ...
        best_score = -999
        moves_me1 = Moves_cutted(moves, cut_num, self.id, game_state)
