...
class myPlayer(AdvancePlayer):
    ...
    def SelectMove(self, moves, game_state):
        ...
        def Moves_cutted(moves):
            ...
            moves_copy = moves_copy[0:10]
            return moves_copy
        
        # the minimax algorithm, google it for what it is
        def minimax(gamecopy, depth, alpha, beta, maximizingPlayer, start_t):
            ...
            if depth is 0 or cur_t>max_turn_time or not (gamecopy.TilesRemaining()):
                ...
                weight = numpy.interp(2-depth, [0, 3*2], [0, 1])
            ...
            if maximizingPlayer:
                ...
                for move_me in moves_me:
                    ...
                    v = minimax(gs_copy, depth-1, alpha, beta, False, start_t)
                ...
                for move_op in moves_op:
                    ...
                    v = minimax(gs_copy, depth-1, alpha, beta, True, start_t)
        ...
        for move_me1 in moves_me1:
            ...
            roundscore_me = minimax(gs_copy1, 3, -999, 999, False, start_time)
