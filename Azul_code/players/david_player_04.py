# MCTS search basic form, using random rollout and ucb1 selection policy
...
class MCTS_search_node(object):
    ...
    def untried_actions(self):
        if self._untried_actions is None:
            ...
            #moves_copy.sort(key = lambda move: (move[2].num_to_pattern_line*scale - move[2].num_to_floor_line) , reverse=True)
